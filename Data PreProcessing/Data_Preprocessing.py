...
#     if == 'Bantamweight'
#     if avg_strikes >=  and avg_control <  and avg_submissions < :
#         return "Volume Striker"
#     elif avg_control >=  and avg_submissions <  and avg_strikes < :
#         return "Controller Wrestler"
#     elif avg_strikes >=  and avg_submissions <  and avg_control < :
#         return "Knockout Artist"
#     elif avg_submissions >=  and avg_control <  and avg_strikes < :
#         return "Submission Specialist"
#     elif 2 <= avg_strikes <  and  <= avg_control <  and avg_submissions >= :
...
#
# # add a new column 'fighter_type' to df_mma1 by mapping the values from average_stats_per_fighter_div
# df_mma1['fighter_type'] = df_merged.apply(lambda row: row['fighter_type'], axis=1)
#
df_mma2.to_csv('updated_fighters5.csv', index=False)
############ EDA ##################################
# via tableau
